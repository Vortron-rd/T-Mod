...
public class BlockDoubleCompressedDiamond extends Block {
    public BlockDoubleCompressedDiamond() {
        super(Material.ROCK);
        this.setCreativeTab(CreativeTab.TMod);
        this.setResistance(6F);
        this.setHardness(7F);
        BlockUtil.nameBlockId(this, "double_compressed_diamond_block");
    }
    public static final Block block = new BlockDoubleCompressedDiamond();
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("blockDoubleCompressedDiamond",itemBlock);
