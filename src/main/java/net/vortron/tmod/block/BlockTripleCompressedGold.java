...
public class BlockTripleCompressedGold extends Block {
    public BlockTripleCompressedGold() {
        super(Material.ROCK);
        this.setCreativeTab(CreativeTab.TMod);
        this.setResistance(6F);
        this.setHardness(10F);
        BlockUtil.nameBlockId(this, "triple_compressed_gold_block");
    }
    public static final Block block = new BlockTripleCompressedGold();
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("blockTripleCompressedGold",itemBlock);
