...
public class BlockDoubleCompressedGold extends Block {
    public BlockDoubleCompressedGold() {
        super(Material.ROCK);
        this.setCreativeTab(CreativeTab.TMod);
        this.setResistance(6F);
        this.setHardness(7F);
        BlockUtil.nameBlockId(this, "double_compressed_gold_block");
    }
    public static final Block block = new BlockDoubleCompressedGold();
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("blockDoubleCompressedGold",itemBlock);
