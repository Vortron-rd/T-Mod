...
public class BlockCompressedGold extends Block {
    public BlockCompressedGold() {
        ...
        this.setHardness(5F);
        BlockUtil.nameBlockId(this, "compressed_gold_block");
    }
    public static final Block block = new BlockCompressedGold();
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("blockCompressedGold",itemBlock);
    }
