...
public class ItemLeafSpade extends ItemSpade {
    public ItemLeafSpade() {
        super(leafToolMaterial);
        this.setCreativeTab(CreativeTab.TMod);
        ItemUtil.nameItemId(this, "leaf_spade");
    }
    public static final Item item = new ItemLeafSpade();


    @SubscribeEvent
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().register(ItemLeafSpade.item);
    }
